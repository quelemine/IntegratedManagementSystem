...
import { ArrowLeft, Users, BookOpen, TrendingUp, Calendar, AlertCircle, DollarSign } from 'lucide-react';
      ...
      <nav className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center py-3 sm:py-0 sm:h-16 gap-3 sm:gap-0">
            ...
            <h1 className="text-lg sm:text-xl font-bold">Principal Dashboard</h1>
          </div>
        </div>
      </nav>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center p-3 bg-red-50 rounded">
                ...
                <span className="font-bold text-red-600">${(stats?.outstandingBalances ?? 0).toLocaleString()}</span>
              </div>
            </div>
          </div>
        </div>
